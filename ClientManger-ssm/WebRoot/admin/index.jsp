...
<iframe class="top-crm" scrolling="yes" frameborder="0" src="admin/top.jsp"></iframe>
<aside class="Hui-aside">
	<input runat="server" id="divScrollValue" type="hidden" value="" />
	<div class="menu_dropdown bk_2">
	<dl id="menu-article">
			<c:forEach var="aa" items="${sessionScope.fuziji}" >
				<dt><i class="Hui-iconfont">&#xe616;</i> ${aa.menuFather}<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
				<dd>
				<ul>
					...
					<c:forEach var="bb" items="${aa.menuNames}">
						...
						<c:forEach var="cc" items="${sessionScope.zi}">
							<c:if test="${cc.menuName eq bb.menuName}"> <li><a _href="${bb.menuUrl}"  href="javascript:void(0)">${bb.menuName}</a></li></c:if>
						</c:forEach>
		...
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a _href="findAllRole.do" href="javascript:void(0)">角色管理</a></li>
					<li><a _href="findAllDept2.do" href="javascript:void(0)">组织机构</a></li>
					<li><a _href="findAllEmp.do" href="javascript:void(0)">员工管理</a></li>
					<li><a _href="findAllMenu.do" href="javascript:void(0)">菜单管理</a></li>
					<li><a _href="findAllNotice.do" href="javascript:void(0)">公告管理</a></li>
					<li><a _href="admin/resource/sys/myinfo/view.jsp" href="javascript:void(0)">个人信息</a></li>
		...
		<dl id="menu-picture">
			...
			<dd>
				<ul> 
					...
					<li><a _href="findByPageStatePlan.do" href="javascript:void(0)">销售计划</a></li>
					<li><a _href="findAllPrediction.do" href="javascript:void(0)">销售预测</a></li>
					<li><a _href="findAllPerformance.do" href="javascript:void(0)">销售绩效</a></li>
					<li><a _href="findAllChance.do" href="javascript:void(0)">机会管理</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a _href="findAllClient.do?type">客户资源管理</a></li>
					<li><a _href="allClientPlan.do">客户发展计划</a></li>
					<li><a _href="findAllClient.do?type=value" href="javascript:void(0)">客户价值管理</a></li>
					<li><a _href="findAllClient.do?type=satisfaction">客户满意度管理</a></li>
		...
		<dl id="menu-comments">
			...
			<dd>
				<ul>
					<li><a _href="findByPageServer.do" href="javascript:;">服务创建</a></li>
					<li><a _href="findByPageServer1.do" href="javascript:void(0)">服务分配</a></li>
					<li><a _href="findByPageServer2.do" href="javascript:void(0)">服务处理</a></li>
					<li><a _href="findByPageServer3.do" href="javascript:void(0)">服务反馈</a></li>
					<li><a _href="findByPageServer4.do" href="javascript:void(0)">服务归档</a></li>
					<li><a _href="findByPageProblem.do" href="javascript:void(0)">常见问题管理</a></li>
...
<section class="Hui-article-box">
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="admin/main.html"></iframe>
		</div>
	</div>
</section>
